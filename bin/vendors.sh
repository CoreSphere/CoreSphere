...
# CoreSphere bundles
mkdir -p $BUNDLES/CoreSphere
cd $BUNDLES//CoreSphere

# WebConsole bundle
install_git ConsoleBundle http://github.com/CoreSphere/ConsoleBundle.git

# Twig Profiling bundle
install_git TwigProfilerBundle http://github.com/CoreSphere/TwigProfilerBundle.git
